...
function mobileNavClass(path) {
  return [
    ...
    isActive(path)
      ? "bg-primary-50 text-primary-600"
      : "text-body hover:bg-surface-soft hover:text-primary-600",
  ];
}
...
<style scoped>
.account-link {
  @apply flex items-center gap-3 rounded-xl px-3 py-2.5 text-sm font-medium text-body transition duration-200 hover:bg-primary-50 hover:text-primary-600;
}
</style>
