    ...
    <div class="page space-y-6">
      ...
      >
        ...
        <div class="flex flex-col justify-center px-6 py-8 sm:px-8 lg:px-12">
          ...
          <p class="mt-4 max-w-xl text-sm leading-6 text-black sm:text-base">
            {{ video.description }}
          </p>
...
const map = {
   ...
   */
  googleMapsUrl:
    "https://maps.google.com/maps?q=10.715007,103.286634&ll=10.715007,103.286634&z=16",

  /*
   * Embedded Google Map
   */
  embedUrl:
    "https://maps.google.com/maps?q=10.715007,103.286634&ll=10.715007,103.286634&z=16&output=embed",
};
